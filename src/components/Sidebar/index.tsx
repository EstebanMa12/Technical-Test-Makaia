...
<aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <span className="text-gray-500 text-sm font-medium" >GENERAL</span>
    <ul className="space-y-2 font-medium text-gray-500">
      <li>
         <a href="#" className="flex items-center p-2 text-gray-900 hover:bg-pink-100  group">
            <HiOutlineHome/>
            <span className="ms-3 text-gray-500  hover:text-pink-800">Home</span>
         </a>
      </li>
      <li>
            <a href="#" className="flex items-center p-2 text-gray-900 hover:bg-pink-100  group">
               <AiOutlineMessage/>
               <span className=" ms-3 text-gray-500 hover:text-pink-800">Messages</span>
            </a>
        </li>
        <li>
            <a href="#" className="flex items-center p-2 text-gray-900 hover:bg-pink-100  group">
                <TfiStatsUp/>
                <span className=" ms-3 text-gray-500 hover:text-pink-800">Reports</span>
            </a>
        </li>
        <li>
            <a href="#" className="flex items-center p-2 text-gray-900  hover:bg-pink-100  group">
                <CiCalendar/>
                <span className=" ms-3 text-gray-500 hover:text-pink-800">Calendar</span>
            </a>
        </li>
    </ul>
    <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
    <span className="text-gray-500 text-sm">WORKSPACE</span>
      <li><a href="#" className="flex items-center p-2 text-gray-900 hover:bg-pink-100  group">
         <VscFileSubmodule/>
         <span className="ms-3 text-gray-500 hover:text-pink-800">Projects</span>
         </a></li>
      <li><a href="#" className="flex items-center p-2 text-gray-900 hover:bg-pink-100  group">
         <IoIosPeople/>
         <span className="ms-3 text-gray-500 hover:text-pink-800">Manage Members</span>
         </a>
         </li>
      </ul>
      <div className="flex flex-col bg-gray-200 rounded-sm w-56 h-24">
         <h3> <MdOutlineRocketLaunch/> Upgrade to Pro</h3>
         <p className="text-gray-400 text-xs">Unlock all pro features</p>
         <button className="rounded-lg bg-sky-500">Upgrade</button>
      </div>
   </div>
</aside>
        </>
